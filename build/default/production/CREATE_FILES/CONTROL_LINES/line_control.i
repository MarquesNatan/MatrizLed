# 1 "CREATE_FILES/CONTROL_LINES/line_control.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "CREATE_FILES/CONTROL_LINES/line_control.c" 2
...
# 3 "CREATE_FILES/CONTROL_LINES/line_control.c" 2

# 1 "CREATE_FILES/CONTROL_LINES/../GPIO/gpio.h" 1
...
{
    uint8_t row = *currRow;
# 79 "CREATE_FILES/CONTROL_LINES/line_control.c"
    if(row < 8)
    {
        row++;
        *currRow = row;
